...
import 'package:military/app/modules/home/views/customs/movie_calendar_view.dart';
import 'package:military/app/ui/theme/app_theme.dart';

import 'package:intl/intl.dart';

class MovieCalendarPopupView extends GetView<MovieCalendarPopupController> {
  HomeController homeController = Get.find();

  MovieCalendarPopupView() {
    controller.barrierDismissible.value = true;
    controller.initialStartDate = homeController.movieStartDate.value;
    controller.initialEndDate = homeController.movieEndDate.value;

    controller.onApplyClick = (DateTime startData, DateTime endData) {
      homeController.movieStartDate.value = startData;
      homeController.movieEndDate.value = endData;
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      GetBuilder<MovieCalendarPopupController>(
                                          builder: (_) => Text(
