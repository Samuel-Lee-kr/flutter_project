...
class CustomCalendarOnedayView extends StatefulWidget {
  const CustomCalendarOnedayView(
      {Key? key,
  ...
  @override
  _CustomCalendarOnedayViewState createState() =>
      _CustomCalendarOnedayViewState();
}

class _CustomCalendarOnedayViewState extends State<CustomCalendarOnedayView> {
              ...
              child: Container(
                child: Stack(
                  children: <Widget>[
                    ...
                    Material(
                      color: Colors.transparent, // 날짜 선택 영역
                      child: InkWell(
                        borderRadius:
  ...
  void onDateClick(DateTime date) {
    ...
    */
    ...
    setState(() {
      try {
        widget.startEndDateChange!(startDate!, DateTime.now());
      } catch (_) {}
    });
  }
}
