...
class MyBodyInfo extends GetView<FoodMenuController> {
  ...
  final TextEditingController _myData2 = TextEditingController();
  final TextEditingController _myData3 = TextEditingController();
  MyBodyInfo({this.animationController, this.animation});
      ...
      builder: (BuildContext context, Widget? child) {
        return FadeTransition(
          ...
          child: Transform(
            ...
            child: Padding(
              padding:
                  const EdgeInsets.only(left: 8, right: 8, top: 16, bottom: 18),
              child: Container(
